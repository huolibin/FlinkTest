...
/**
  ...
  * @date Created by sheting on 2019/7/1 16:42
  *
  */
...
object stream_join {
  def main(args: Array[String]): Unit = {
    ...
    //获取接口传送的数据
    val dataStream1 = env.readTextFile("e:/ceshi/flink_data/scoket1.txt")
    val dataStream2 = env.readTextFile("e:/ceshi/flink_data/scoket2.txt")
