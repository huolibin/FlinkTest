 ...
 * broadcast分区规则，把元素广播给所有的分区，数据会被重复处理
 */
public class Broad_Source_demo1 {
    public static void main(String[] args) throws Exception {
        ...
        //整理数据
        SingleOutputStreamOperator<Long> map = text.broadcast().map(new MapFunction<Long, Long>() {
            @Override
        ...
        String jobName = Broad_Source_demo1.class.getSimpleName();
        env.execute(jobName);
