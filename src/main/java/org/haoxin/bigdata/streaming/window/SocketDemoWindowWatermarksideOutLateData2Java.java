...
/**
 * 多并行度的watermark 的应用
 * sideOutputLateData收集迟到的数据
 *
 * @author huolibin@haoxin.cn
 * @date Created by sheting on 2019/8/13 11:48
 */
public class SocketDemoWindowWatermarksideOutLateData2Java {
    public static void main(String[] args) throws Exception{
        ...
        //对数据进行窗口计算
        SingleOutputStreamOperator<String> applyData = watermarksStream.keyBy(0).window(TumblingEventTimeWindows.of(Time.seconds(3)))//按照消息的EventTime分配窗口，和调用TimeWindow效果一样
        ...
        //把迟到的数据暂时打印在控制台，生产中保存在其他存储介质中
        DataStream<Tuple2<String, Long>> sideOutput = applyData.getSideOutput(outputTag);
        sideOutput.print();
